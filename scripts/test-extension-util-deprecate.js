...
async function testExtensionUtilDeprecate() {
    console.log('🚀 Testing extension util-deprecate polyfill...');
    ...
    const playwrightArgs = [
        'playwright', 
        'test', 
        'test/playwright/extension-util-deprecate-test.test.ts', 
        '--project=chromium-extension',  // Use extension project
        '--timeout=60000'      // 60 seconds timeout for extension loading
    ];
    ...
    return new Promise((resolve, reject) => {
        ...
        child.on('close', (code, signal) => {
            ...
            if (code === 0) {
                console.log('🎉 Extension util-deprecate test passed!');
            } else {
                console.log('❌ Extension util-deprecate test failed');
            }
        ...
        // 60 second timeout for extension loading
        const timeout = setTimeout(() => {
            if (isCompleted) return;
            
            console.log('\n⏰ 60 second timeout reached - killing process');
