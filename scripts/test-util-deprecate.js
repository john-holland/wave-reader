...
async function testUtilDeprecate() {
    console.log('🚀 Testing util-deprecate polyfill...');
    ...
    const playwrightArgs = [
        'playwright', 
        'test', 
        'test/playwright/util-deprecate-test.test.ts', 
        '--project=chromium',  // Use default chromium project
    ...
    return new Promise((resolve, reject) => {
        ...
        child.on('close', (code, signal) => {
            ...
            if (code === 0) {
                console.log('🎉 Util-deprecate polyfill test passed!');
            } else {
                console.log('❌ Util-deprecate polyfill test failed');
            }
