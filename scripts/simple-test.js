...
async function runSimpleTest() {
    console.log('🚀 Running simple console log test...');
    ...
    const playwrightArgs = [
        'playwright', 
        'test', 
        'test/playwright/simple-console-test.test.ts', 
        '--project=chromium',  // Use default chromium project instead of chromium-extension
    ...
    return new Promise((resolve, reject) => {
        ...
        child.on('close', (code, signal) => {
            ...
            if (code === 0) {
                ...
                console.log('❌ Simple test failed or timed out');
            }
